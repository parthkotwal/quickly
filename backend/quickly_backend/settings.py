...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-g7zt*rsi1-46c()7f0j6xecc29t$o)mxv4t0p-b8p2e$%okk#=')
...
# Caching (in-memory for dev, switch to Redis for prod)
CACHES = {
    'default': {
